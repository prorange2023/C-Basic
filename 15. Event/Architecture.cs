        ...
        ****************************************************************/
        ...
        public class Call
        {
            ...
            public class Polling
            {
                ...
                // 단점 : 변경사항이 없는 경우에도 계속 UI가 확인해야하는 불필요한 연산이 발생
                // 이벤트가 최고고 폴방식 구린거 같지만 오히려 이벤트가 느린 경우가 있음. 어떤 경우냐? 위치, 속도, 충돌 같은거(실시간으로, 너무 빠르게 변경됨)
                ...
                public class UI
                {
                    ...
                    public void Update() // 유니티에선 업데이트라고 함. 게임 프레임 당 1회 실행 유니티때 프레임 개념 얘기하면서 한번 더 할 예정
                    {
            ...
            public class Event
            {
                ...
                // 단점 : 이벤트를 구성하기 위한 추가적인 소스를 작성해야 함 (붙여주는 작업이 필요하다는 말)
