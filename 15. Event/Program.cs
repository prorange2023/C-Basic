namespace _15._Event
{
    internal class Program
    {
        ...
        public class Player
        {
            public event Action OnGetCoin;      // 여기써있는 event 는 델리게이트 변수 를 이벤트로만 쓸수 있다는 선언. 그래서 대입도 막히고 외부에서 이벤트 발생시키는 것도 막힘.
            ...
            {
                Console.WriteLine("플레이어가 데미지를 입음");
        ...
        static void Main(string[] args)
        {
            ...
            // 주의점
            // 1. 델리게이트 체인 = 대입도 가능, 누가 미스내면 초기화나 다름없는 사고가
            // player.OnGetCoin = sfx.CoinSound();
