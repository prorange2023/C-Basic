namespace _11._Generic
{
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            // 개인적으로 구조체랑 투탑으로 머리속에 정립안된상황. 서둘러서 복습할것.
            /*******************************************************************
              * 배열 (Array)
              * 
              * 기반이 클래스라는걸 이해해라?
            ...
            // <배열의 구현 원리>
            // C#의 배열은 Array 클래스를 통해 구현됨 <= 클래스를 통해 만들어진다 요점
            ...
            int index = Array.IndexOf(array, 3);    // 배열 탐색(몇번째에 있어? 좌측 답은 1. 0부터 시작하고 두번째니까)
            ...
            // 위의 응용이 아래 배열이 배열되있는거다 쉽게말해서
            // <가변 배열>
            // 배열의 []괄호를 배열 갯수만큼 추가
            // 배열의 크기를 각각 설정 가능
            int[][] jagged = new int[3][];          // 배열의 갯수 설정 //인트배열을 배열 개 들고있다고 이해해라
            jagged[0] = new int[5];
            jagged[1] = new int[2];
            jagged[2] = new int[3];
            // [0][0] [0][1] [0][2] [0][3] [0][4]
